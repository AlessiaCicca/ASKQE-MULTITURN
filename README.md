...
```python
python qg.py  --input_path <input_file> --output_path <output_file> ...prompt_path <prompt_file> --prompt_key <qg_prompt>
```

### Question Answering

```python
python qa.py --input_path <input_file> --output_path <output_file> ...prompt_path <prompt_file> --prompt_key <qa_prompt>
```
